...
int main()
{
    const char *month_names[12] = {"January", "February", "March", "April", "May", "June", "July", "August",
...
char *nums_to_string_date(  char *date_string,  // Output - string representation
                            int month, int day, int year, // Input - representation as three numbers
                            const char *month_names[]) // Input - string representation of months
{
...
{
    int i;
    int found = 0; // whether or not target has been found
...
/*
*   Converts date represented as a string containing a month name to three
*   integers representing month, day, and year
*/

void string_date_to_nums(const char *date_string,   // Input date to convert
                        int *monthp,                // Output month number
                        int *dayp,                  // Output day number
                        int *yearp,                 // Output year number
                        const char *month_names[])  // Input - names used in date string
{
    char mth_nam[STRSIZ];
    int month_index;
